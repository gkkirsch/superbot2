...
# Superbot2 installer
# Usage: curl -fsSL https://raw.githubusercontent.com/your-username/superbot2/main/install.sh | bash
...
if [[ -n "${SUPERBOT2_LOCAL:-}" ]]; then
  ...
  git clone https://github.com/your-username/superbot2.git "$INSTALL_DIR"
fi
