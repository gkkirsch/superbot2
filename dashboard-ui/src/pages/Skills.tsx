...
import { Blocks, Sparkles, Bot, Webhook, Puzzle, Download, Trash2, Loader2, X, Terminal, BookOpen, Cpu, FileText, ChevronRight, Search, Plus, Store, RefreshCw, Key, Check, AlertTriangle, Wrench, ArrowRight, Cable, Send, Chrome } from 'lucide-react'
import { Link } from 'react-router-dom'
import { usePlugins, useMarketplaces, usePluginCredentials } from '@/hooks/useSpaces'
import { installPlugin, uninstallPlugin, fetchPluginDetail, fetchPluginFile, addMarketplace, removeMarketplace, refreshMarketplaces, savePluginCredential, deletePluginCredential, installPluginBin, getTelegramStatus, startTelegramWatcher, stopTelegramWatcher, getBrowserStatus, setupBrowser, openBrowser } from '@/lib/api'
import type { TelegramStatus, BrowserStatus } from '@/lib/api'
import type { PluginInfo, PluginDetail, PluginComponent, CredentialDeclaration, MissingBin } from '@/lib/types'
import { TelegramSetupModal } from '@/features/SuperbotSkillsSection'
