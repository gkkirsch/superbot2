        ...
        <div className="flex flex-wrap gap-1.5">
          {workers.map((w) => (
            <Link
              ...
              className="relative inline-flex items-center gap-1.5 overflow-hidden rounded-full bg-stone/10 px-2.5 py-0.5 text-[10px] text-stone/70 hover:text-sand hover:bg-stone/20 transition-colors"
            >
              ...
              <span className="max-w-[120px] truncate relative">{w.name}</span>
            </Link>
          ))}
        </div>
      )}
