...
description: >
  Creates animation-rich standalone HTML slideshows from scratch or from PowerPoint files.
  Invoke when user wants to create a presentation, slideshow, or pitch deck.
  Helps non-designers discover their aesthetic through visual exploration rather than abstract choices.
allowed-tools:
  - Read
  - Write
  - Edit
